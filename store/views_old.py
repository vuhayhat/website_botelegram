...
class UpdateCartView(View):
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse({
            ...
            'item_subtotal': 0 if action in ['remove'] or (action == 'decrease' and cart_item.quantity <= 1) else cart_item.subtotal,
            'item_quantity': 0 if action in ['remove'] or (action == 'decrease' and cart_item.quantity <= 1) else cart_item.quantity,
